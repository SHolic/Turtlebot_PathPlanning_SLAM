...
def generate_launch_description():
    ...
    turtlebot3_move_cam_node = Node(
        package='navigation_pkg',
        executable='turtlebot3_move_cam',
        name='turtlebot3_move_cam',
        output='screen',
        emulate_tty=True,
    ...
    map_update_node = Node(
        package='navigation_pkg',
        executable='map_update_node',
    ...
    # ld.add_action(turtlebot3_move_cam_node)
    ld.add_action(image_processing_node)
    ld.add_action(map_update_node)
    ld.add_action(path_planning_node)
    ld.add_action(goal_commander_node)
